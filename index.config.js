...
var index_config_default = {
  ...
  {name: "📺哇哇2",
   ...
   {name: "📺橘子",
      address: "https://catbox.n13.club/ai/橘子APP.php"},
   {name: "📺段友",
      address: "https://catbox.n13.club/ai/段友APP.php"},
   {name: "📺王子",
      address: "https://catbox.n13.club/ai/王子APP.php"},
   {name: "📺火猫",
      address: "https://catbox.n13.club/ai/火猫APP.php"},
   {name: "📺灵虎",
      address: "https://catbox.n13.club/ai/灵虎APP.php"},
   {name: "📺爱盈",
      address: "https://catbox.n13.club/ai/爱盈APP.php"},
   {name: "📺缘梦",
      address: "https://catbox.n13.club/ai/缘梦APP.php"},
   {name: "📺老鹰",
      address: "https://catbox.n13.club/ai/老鹰APP.php"},
  {name: "📺蓝鹰",
      address: "https://catbox.n13.club/ai/蓝鹰APP.php"},
   {name: "📺茉莉",
      address: "https://catbox.n13.club/ai/茉莉APP.php"},
   {name: "📺蘑菇",
      address: "https://www.5o5k.com/api.php/provide/vod/"},
  {name: "📺金牌3",
      address: "https://catbox.n13.club/ai/金牌APP.php"},
  {name: "📺顾我",
      address: "https://catbox.n13.club/ai/顾我APP.php"},
   {name: "📺PY",
      address: "http://zhangqun1818.serv00.net/py.php"},
   {name: "📺js",
      address: "http://zhangqun1818.serv00.net/js.php"},
  {name: "📺驿站",
      address: "https://catbox.n13.club/ai/驿站APP.php"},
  {name: "📺黑猫",
      address: "https://catbox.n13.club/ai/黑猫APP.php"},
   {name: "📺央影",
    ...
    {name: "📺哇哇",
      address: "https://catbox.n13.club/t9/哇哇影视.php"},
   {name: "📺采集2",
 ...
 emby: [
  {
     ...
     {
      name: "HOHAI",
      server: "https://emby.hohai.eu.org:443",
      username: "twicelove",
      password: "hrd8523125",
      deviceName: "Hills Windows",
      client: "Hills Windows",
    ...
    {
      name: "Cinetry",
      server: "http://154.217.240.24:8096",
      username: "Cinetry",
      password: "xinniankuaile",
      deviceName: "Hills Windows",
      client: "Hills Windows",
      clientVersion: "",
      enablePlaybackReport: true
...
{
      name: "七十二时",
      server: "https://alist.20237737.xyz:443",
      path: "/dav",
      username: "davguest",
      password: "davguest",
      enabled: true
